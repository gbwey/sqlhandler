...
allTests =
  ...
  , expectD (Right ((Refined3 [127,1,0,199] "127.001.000.199") ,[])) (unDec (defDec :: Dec (Refined3 (Resplit "\\." >> Map (ReadP Int)) (Guard "length" (Len >> Same 4) >> Guard "octet 0-255" (All (Between 0 255)) >> 'True) (Printfnt 4 "%03d.%03d.%03d.%03d") String)) [SqlString "127.1.0.199"])
  ...
  , expectD (Right ((Refined3 [127,1,0,4] "127.001.000.004", []))) (unDec (defDec :: Dec (MakeR3 Ip)) [SqlString "127.1.0.4"])
  ...
  , expectD (Right ((Refined3 [123,45,6789] "123-45-6789", []))) (unDec (defDec :: Dec (MakeR3 Ssn)) [SqlString "123-45-6789"])
  ...
  , expectD (Right ((Refined 8), [])) (unDec (defDec :: Dec (Refined (Between 4 10 && Id /= 7) Int)) [SqlInt32 8])
