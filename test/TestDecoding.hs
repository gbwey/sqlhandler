...
allTests =
  ...
  , expectD (Left "Refined3 Step 2. Failed Boolean Check(op) | Guards: invalid length:expected 4 but found 5") (unDec (defDec :: Dec (R3.MakeR3 R3.Ip4)) [SqlString "127.1.0.4.5"])
  ...
  , expectD (Right ((R2.unsafeRefined2 [127,1,0,199] "127.1.0.199") ,[])) (unDec (defDec :: Dec (R2.Refined2 (Map (ReadP Int Id) (Resplit "\\." Id)) (Guard "length" (Len == 4) >> Guard "octet 0-255" (All (Between 0 255) Id) >> 'True)  String)) [SqlString "127.1.0.199"])
  ...
  , expectD (Left "Refined2 Step 2. Failed Boolean Check(op) | Guards: invalid length:expected 4 but found 5") (unDec (defDec :: Dec (R2.MakeR2 R2.Ip4)) [SqlString "127.1.0.4.5"])
